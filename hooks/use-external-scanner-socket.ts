...
export function useExternalScannerSocket({
    ...
    }, [wsServerUrl, isEnabled, userId, classId, onBarcodeReceived, cleanupSocket]);
    ...
    }, [isEnabled, userId, classId, connectWebSocket, cleanupSocket]);

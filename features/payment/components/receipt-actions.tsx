...
import { printReceipt, downloadReceiptAsPDF, downloadReceiptAsImage } from "../utils/receipt-utils"
...
export const ReceiptActions: React.FC<ReceiptActionsProps> = ({ payment, receiptElementId, className = "" }) => {
  const handlePrint = () => {
    try {
  ...
  return (
    <div className={`flex flex-wrap gap-2 ${className}`}>
      ...
      <Button variant="outline" size="sm" onClick={handleDownloadImage} className="flex items-center gap-1">

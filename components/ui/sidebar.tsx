...
function SidebarProvider({
  ...
  // This makes it easier to style the sidebar with Tailwind courses.
  ...
  return (
    ...
    >
      ...
      <Avatar className="h-8 w-8">
        ...
        />
        <AvatarFallback className="h-7 w-7 rounded-full bg-muted/5 backdrop-blur-sm text-primary hover:bg-primary/20 cursor-pointer hover:border hover:border-primary font-medium" >

                            ...
                            <div className="relative">
                                <SheetTrigger asChild>
                                    <Avatar>
                                        ...
                                        />
                                        <AvatarFallback className="relative h-7 w-7 rounded-full bg-muted/5 backdrop-blur-sm text-primary hover:bg-primary/20 cursor-pointer hover:border hover:border-primary font-medium">
                                                    ...
                                                    <SheetClose asChild >
                                                        <Link href="/profile" className="mb-2 flex items-center space-x-4 rounded-xl p-2 bg-accent/50 hover:bg-accent transition-colors ease-[cubic-bezier(0.77, 0, 0.175, 1)] duration-300">
                                                            <Avatar className="size-10">
                                                                ...
                                                                <AvatarFallback className="flex h-10 w-10 items-center justify-center rounded-full bg-muted/5 backdrop-blur-sm text-primary font-medium">{user.name?.charAt(0).toUpperCase() || 'U'}</AvatarFallback>
                                                            </Avatar>

        ...
        return (
            <div className="max-h-[80vh] overflow-y-auto">
                ...
                <div className="p-6 border-t flex justify-between items-center mt-auto">
                    ...
                    <div>
                        {course.discountPriceUSD && (
                            <span className="text-sm text-muted-foreground line-through mr-2">{renderNairaPrice(nairaAmount)}</span>
                        )}
                        <div className="text-xl font-bold text-primary h-5">{renderNairaPrice(displayNairaAmount)}</div>{" "}
